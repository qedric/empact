...
contract Generator_v1 is AccessControl {
        ...
        return abi.encodePacked(
            ...
            Base64.encode(bytes(string(
                abi.encodePacked(
                    ...
                    ';}</style></defs><rect class="cls-2" y="0" width="1080" height="1080"/><rect class="cls-1" y="0" width="1080" height="',
                    uint2str((100 - percent) * 108 / 10),
